  ...
  render() {
    ...
    return (
      <div className={(this.props.type === GalleryCardType.detailed) ? "mdl-cell mdl-cell--12-col" : "mdl-cell mdl-cell--4-col"}>
        <div className={"galleryCard mdl-card mdl-shadow--3dp galleryCard" + this.props.type}
          style={{ background: 'url(' + this.props.item + ') center / cover' }}
          onClick={() => (this.props.type === GalleryCardType.list) && this.props.onToggleGallery()} >
